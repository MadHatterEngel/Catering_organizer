...
try:
    ...
    [data-testid="stFileUploader"] button {{
        ...
        border: 1px solid #5e3a8c !important;
        font-weight: bold;
    }}
    </style>
    '''
...
if uploaded_file is not None:
    ...
    with st.spinner("Analyzing PDF layout and calculating totals..."):
        ...
        # We pass the raw PDF bytes directly to Gemini 2.5 Flash's vision engine
        ...
        2. DO THE MATH: Aggregate every single identical item. If there are 15 Medium-Rare Sirloins, output the total 15. Do not list items one by one. Treat different sizes (e.g., 'Large' vs 'Small') as completely separate items.
        3. Extract the Order Number, Client/Platform (e.g., Zifty Dispatch), Date, Time, and Headcount for the header. If the Date or Time says "Incomplete" or is missing, write "Not Specified".
        ...
        # Call the AI using the 2.5 model and passing the document directly
    ...
    with st.spinner("Generating beautiful PDF..."):
        # Convert the AI-generated HTML into a downloadable PDF
